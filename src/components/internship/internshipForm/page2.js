                            ...
                            <div >
                                ...
                                <Form.List  name="intern-responsibilities">
                                    ...
                                    return (
                                        ...
                                        <Form.Item>
                                            <div className="add-btn add-btn-responsibliliy" onClick={() => {add()}}>+Add Responsibilities</div>
                                        </Form.Item>
                                        </section>
                                    );
                                    }}
                                    ...
                                    return (
                                        ...
                                        {fields.map((field, index) => (
                                            ...
                                            <div style={{ display: "flex", width: "100%" }}>
                                                <Form.Item
                                                name={[field.name]}
                                                fieldKey={[field.fieldKey, "requirements-from-interns"]}
                                                rules={rules}
                                                >
                                                <Input  prefix={ index + 1 + "." } placeholder={''} />
                                                </Form.Item>
                                        ...
                                        <Form.Item>
                                            <div className="add-btn add-btn-requirement" onClick={() => {add()}}>+Add Responsibilities</div>
                                        </Form.Item>
                                        </section>
                                    );
                                    }}
                                ...
                                >
                                    <Select style={{ width: "25rem"}} mode="multiple" placeholder="Type skills" >
                            ...
                            <h2>Interview Questions</h2>
                                <Form.List  name="interview-questions">
                                    ...
                                    return (
                                        ...
                                        <Form.Item>
                                            <div className="add-btn add-btn-interview-ques" onClick={() => {add()}}>+Add Responsibilities</div>
                                        </Form.Item>
                                        </section>
                                    );
                                    }}
