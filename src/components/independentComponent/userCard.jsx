...
export default function UserCard(props) {
  ...
  console.log('%c PROFILE SCORE ' + profileScore, 'font-size: 25px, color: darkblue' )
  return (
      ...
      <div className="education-block-one">
        ...
        >
          ...
          <div className="resume-digital-profiles">
              ...
              {github ? <div className="digital-profile-container"><i class="fa fa-github fa-2x" style={{color: "#333"}} aria-hidden="true"></i><a href={"https://" + github} target="_blank"  className="link-text">{github}</a></div> : null}
